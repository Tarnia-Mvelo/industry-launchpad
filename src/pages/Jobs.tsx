...
const Jobs = () => {
  ...
  const jobs = [
    ...
    },
    {
      ...
      salary: "$100k - $140k",
      description: "Build scalable backend systems and APIs for our AI-powered analytics platform.",
    ...
    },
    {
      ...
      experience: "Junior",
      salary: "$70k - $95k",
      description: "Create beautiful and responsive user interfaces for mobile and web applications.",
    ...
    },
    {
      ...
      experience: "Mid-level",
      salary: "$105k - $135k",
      description: "Work across the entire stack to deliver features and maintain our growing platform.",
